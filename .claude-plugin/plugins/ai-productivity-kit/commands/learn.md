...
/learn https://docs.example.com/api ./api-notes.md

# เรียนรู้พร้อมระบุประเภท
/learn https://example.com --type=pattern
```
...
```
User: /learn https://react.dev/reference/react
...
- `/ai-kit:learn` - Manual learning capture
